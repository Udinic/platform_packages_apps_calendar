...
public class ICalendar {
    ...
    public static class Property {
        ...
        /**
         * Adds a {@link com.android.calendarcommon2.ICalendar.Parameter} to this property.
     ...
     * @throws com.android.calendarcommon2.ICalendar.FormatException Thrown if the text could not be parsed into an
     ...
     * @param text The text to be parsed.
     * @return The top-level component.
     * @throws com.android.calendarcommon2.ICalendar.FormatException Thrown if the text could not be parsed as an
     * iCalendar object.
     */
