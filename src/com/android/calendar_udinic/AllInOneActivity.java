...
import com.android.calendar_udinic.CalendarController.ViewType;
import com.android.calendar_udinic.agenda.AgendaFragment;
import com.android.calendar_udinic.extensions.AllInOneMenuExtensions;
import com.android.calendar_udinic.month.MonthByWeekFragment;
import com.android.calendar_udinic.selectcalendars.SelectVisibleCalendarsFragment;
        ...
        if (event.eventType == EventType.GO_TO) {
            ...
            if (mShowCalendarControls) {
                ...
                if (noControlsView || mHideControls) {
                    // hide minimonth and calendar_udinic frag
                    ...
                    // show minimonth and calendar_udinic frag
                    mShowSideViews = true;
                    mMiniMonth.setVisibility(View.VISIBLE);
                    mCalendarsList.setVisibility(View.VISIBLE);
                    mMiniMonthContainer.setVisibility(View.VISIBLE);
