...
import com.android.calendar_udinic.AbstractCalendarActivity;
...
public class EditEventHelper {
    ...
    public String updatePastEvents(ArrayList<ContentProviderOperation> ops,
        ...
        if (origRecurrence.count > 0) {
            ...
            // The "until" time must be in UTC time in order for Google calendar_udinic
    ...
    /**
     * Uses a calendar_udinic cursor to fill in the given model This method assumes the
    ...
    public static boolean canRespond(CalendarEventModel model) {
        // For non-organizers, write permission to the calendar_udinic is sufficient.
        // For organizers, the user needs a) write permission to the calendar_udinic
        // AND b) ownerCanRespond == true AND c) attendee data exist
        // (this means num of attendees > 1, the calendar_udinic owner's and others).
