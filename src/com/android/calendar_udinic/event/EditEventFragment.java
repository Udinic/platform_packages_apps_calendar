...
import com.android.calendar_udinic.AsyncQueryService;
import com.android.calendar_udinic.CalendarController;
import com.android.calendar_udinic.CalendarController.EventHandler;
...
import com.android.calendar_udinic.DeleteEventHelper;
                ...
                case TOKEN_CALENDARS:
                    try {
                        if (mModel.mCalendarId == -1) {
                            // Populate Calendar spinner only if no calendar_udinic is set e.g. new event
    ...
    class Done implements EditEventHelper.EditDoneRunnable {
        ...
        public void run() {
            ...
            if ((mCode & Utils.DONE_EXIT) != 0) {
                ...
                // when we want to return to the main calendar_udinic views
