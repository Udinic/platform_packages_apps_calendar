...
public class EventViewUtils {
     ...
     * (perhaps because we don't think it's allowed for this calendar_udinic), we return zero (the
    ...
    /**
     * Remove entries from the method list that aren't allowed for this calendar_udinic.
     *
