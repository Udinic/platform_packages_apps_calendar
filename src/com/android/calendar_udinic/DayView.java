...
public class DayView extends View implements View.OnCreateContextMenuListener,
     ...
     * during calendar_udinic syncs. This becomes valid when an event is selected, either by default
     * on starting calendar_udinic or by scrolling to an event. It becomes invalid when the user
...
//    }
    ...
    private void doScroll(MotionEvent e1, MotionEvent e2, float deltaX, float deltaY) {
        ...
        if ((mTouchMode & TOUCH_MODE_VSCROLL) != 0) {
            // Calculate the top of the visible region in the calendar_udinic grid.
            // Increasing/decrease this will scroll the calendar_udinic grid up/down.
    ...
    private static int getEventAccessLevel(Context context, Event e) {
        ...
        // Get the calendar_udinic id for this event
