...
import static com.android.calendar_udinic.CalendarController.EVENT_EDIT_ON_LAUNCH;
...
import com.android.calendar_udinic.CalendarController.EventInfo;
import com.android.calendar_udinic.CalendarController.EventType;
...
import com.android.calendar_udinic.alerts.QuickResponseActivity;
import com.android.calendar_udinic.event.AttendeesView;
import com.android.calendar_udinic.event.EditEventActivity;
import com.android.calendar_udinic.event.EditEventHelper;
import com.android.calendar_udinic.event.EventViewUtils;
...
public class EventInfoFragment extends DialogFragment implements OnCheckedChangeListener,
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            ...
            case TOKEN_QUERY_VISIBLE_CALENDARS:
                if (cursor.getCount() > 1) {
                    // Start duplicate calendars query to detect whether to add the calendar_udinic
                    // email to the calendar_udinic owner display.
                    ...
                    // Don't need to display the calendar_udinic owner when there is only a single
                    // calendar_udinic.  Skip the duplicate calendars query.
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // Home button - close event info activity and start the main calendar_udinic
        // one
    ...
    void updateResponse(View view) {
        ...
        // a) you can edit the event's containing calendar_udinic AND
        // b) you're not the organizer and only attendee AND
        // c) organizerCanRespond is enabled for the calendar_udinic
        // (if the attendee data has been hidden, the visible number of attendees
        // will be 1 -- the calendar_udinic owner's).
