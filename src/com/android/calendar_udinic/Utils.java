...
import com.android.calendar_udinic.CalendarUtils.TimeZoneUtils;
...
public class Utils {
    ...
    static final String MACHINE_GENERATED_ADDRESS = "calendar_udinic.google.com";
     ...
     * This travels a cursor containing calendar_udinic display names and fills in the
    ...
    public static Intent createEmailAttendeesIntent(Resources resources, String eventTitle,
        ...
        // Start the email intent.  Email from the account of the calendar_udinic owner in case there
     ...
     * or another calendar_udinic, etc.  These all end in "calendar_udinic.google.com".
     */
    ...
    /**
     * Returns true if:
     *   (1) the email is not a resource like a conference room or another calendar_udinic.
     *       Catch most of these by filtering out suffix calendar_udinic.google.com.
