...
public class GoogleCalendarUriIntentFilter extends Activity {
    ...
    /**
     * Extracts the ID and calendar_udinic email from the eid parameter of a URI.
     *
     * The URI contains an "eid" parameter, which is comprised of an ID, followed
     * by a space, followed by the calendar_udinic email address. The domain is sometimes
     * shortened. See the switch statement. This is Base64-encoded before being
     * added to the URI.
     *
     * @param uri incoming request
     * @return the decoded event ID and calendar_udinic email
     */
                    ...
                    if (decodedBytes[decodedBytes.length - 2] == '@') {
                        ...
                        switch(decodedBytes[decodedBytes.length - 1]) {
                            case 'm':
                                ...
                                break;
                            case 'g':
                                domain = "group.calendar_udinic.google.com";
                                break;
                            case 'h':
                                domain = "holiday.calendar_udinic.google.com";
                                break;
                            case 'i':
                                domain = "import.calendar_udinic.google.com";
                                break;
                            case 'v':
                                domain = "group.v.calendar_udinic.google.com";
                                break;
                            default:
                ...
                if (eidParts != null) {
                    ...
                    if (eventCursor != null && eventCursor.getCount() > 0) {
                        ...
                        while (eventCursor.moveToNext()) {
                            ...
                            // Send intent to calendar_udinic app
