...
package com.android.calendar_udinic.selectcalendars;
...
public class SelectSyncedCalendarsMultiAccountAdapter extends CursorTreeAdapter implements
    ...
    /**
     * Method for changing the sync state when a calendar_udinic's button is pressed.
     *
     * This gets called when the CheckBox for a calendar_udinic is clicked. It toggles
     * the sync state for the associated calendar_udinic and saves a change of state to
    ...
    protected void bindChildView(View view, Context context, Cursor cursor, boolean isLastChild) {
        ...
        // First see if the user has already changed the state of this calendar_udinic
