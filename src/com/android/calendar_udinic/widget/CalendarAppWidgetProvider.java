...
package com.android.calendar_udinic.widget;
...
import com.android.calendar_udinic.AllInOneActivity;
import com.android.calendar_udinic.EventInfoActivity;
import com.android.calendar_udinic.R;
import com.android.calendar_udinic.Utils;

/**
 * Simple widget to show next upcoming calendar_udinic event.
 */
public class CalendarAppWidgetProvider extends AppWidgetProvider {
    ...
    static final String EXTRA_EVENT_IDS = "com.android.calendar_udinic.EXTRA_EVENT_IDS";
    ...
    public void onReceive(Context context, Intent intent) {
        // Handle calendar_udinic-specific updates ourselves because they might be
    ...
    private void performUpdate(Context context,
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            // Launch calendar_udinic app when the user taps on the header
            ...
            launchCalendarIntent
                    .setData(Uri.parse("content://com.android.calendar_udinic/time/" + millis));
    ...
    /**
     * Build the {@link PendingIntent} used to trigger an update of all calendar_udinic
     ...
     * If the go to time is 0, then calendar_udinic will be launched without a starting time.
     *
     * @param goToTime time that calendar_udinic should take the user to, or 0 to
     *            indicate no specific start time.
     */
    static Intent getLaunchFillInIntent(Context context, long id, long start, long end,
            boolean allDay) {
        final Intent fillInIntent = new Intent();
        String dataString = "content://com.android.calendar_udinic/events";
        if (id != 0) {
